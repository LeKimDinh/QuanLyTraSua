...
insert into Customer values('V1', 'Phan Son', '2019-01-13', '0268845614');
insert into Customer values('V2', 'Phan Danh', '2019-04-18','045231786');
insert into Customer values('V3', 'Phan Duy', '2019-07-13', '0986524715');
insert into Customer values('V1', 'Phan Đức', '2019-09-23', '0125784658');
insert into Customer values('V1', 'Phan Anh', '2019-09-18', '0984521762');
insert into Discount values('3', '0268845614');
insert into Discount values('5', '0986524715');
insert into Discount values('5', '0984521762');
