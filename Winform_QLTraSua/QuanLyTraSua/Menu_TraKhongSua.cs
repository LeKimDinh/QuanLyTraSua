...
{
    public partial class Menu_TraKhongSua : UserControl
    {
        DataTable dt = null;
        ...
        private void LoadData()
        {
            try
            {
                dt = new DataTable();
                dt.Clear();
                DataSet ds = Drinks.LayDrinks("C3");
                dt = ds.Tables[0];
        ...
        private void Menu_TraKhongSua_Load(object sender, EventArgs e)
        {
