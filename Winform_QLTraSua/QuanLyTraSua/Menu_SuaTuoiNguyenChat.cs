...
{
    public partial class Menu_SuaTuoiNguyenChat : UserControl
    {
        DataTable dt = null;
        ...
        private void LoadData()
        {
            try
            {
                dt = new DataTable();
                dt.Clear();
                DataSet ds = Drinks.LayDrinks("C4");
                dt = ds.Tables[0];
        ...
        private void Menu_SuaTuoiNguyenChat_Load(object sender, EventArgs e)
        {
